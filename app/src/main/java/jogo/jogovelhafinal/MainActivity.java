...
public class MainActivity extends AppCompatActivity {
    ...
    private Jogo l1, l2, l3, c1, c2, c3, d1, d2;
    private ImageButton[] iB = new ImageButton[9];
    private int jogadas, jogador = 0;
    private String[] pl = {"Jogador1", "Jogador2"};
    ...
    public void clickListener(View v) {
        ...
        Jogo j = ((Jogos) b.getTag()).gamesAddSerie(jogador);

        TextView t = (TextView) findViewById(R.id.textView);
        t.setText((j != null) ? fimJogo(j.getImageButtons(), jogador) : verificaVelha(++jogadas));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Lista de possibilidades de vitoria
        l1 = new Jogo(iB[0], iB[1], iB[2]);
        l2 = new Jogo(iB[3], iB[4], iB[5]);
        l3 = new Jogo(iB[6], iB[7], iB[8]);
        c1 = new Jogo(iB[0], iB[3], iB[6]);
        c2 = new Jogo(iB[1], iB[4], iB[7]);
        c3 = new Jogo(iB[2], iB[5], iB[8]);
        d1 = new Jogo(iB[0], iB[4], iB[8]);
        d2 = new Jogo(iB[2], iB[4], iB[6]);

        //Primeiro fila
        iB[0].setTag(new Jogos(l1, c1, d1));
        iB[1].setTag(new Jogos(l1, c2));
        iB[2].setTag(new Jogos(l1, c3, d2));
        //Segunda fila
        iB[3].setTag(new Jogos(l2, c1));
        iB[4].setTag(new Jogos(l2, c2, d1, d2));
        iB[5].setTag(new Jogos(l2, c3));
        //Terceira fila
        iB[6].setTag(new Jogos(l3, c1, d2));
        iB[7].setTag(new Jogos(l3, c2));
        iB[8].setTag(new Jogos(l3, c3, d1));
    }
